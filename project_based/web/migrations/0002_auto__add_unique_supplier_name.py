...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Supplier', fields ['name']
        db.create_unique(u'web_supplier', ['name'])

    def backwards(self, orm):
        # Removing unique constraint on 'Supplier', fields ['name']
        db.delete_unique(u'web_supplier', ['name'])
